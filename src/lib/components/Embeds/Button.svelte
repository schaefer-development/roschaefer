...
<button
	class="w-full aspect-video top-0 left-0 flex flex-col justify-center items-center text-white hover:bg-black hover:bg-opacity-30 transition ease-in-out duration-250"
	on:click
